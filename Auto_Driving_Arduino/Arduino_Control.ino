...
*/
  ...
  server.on("/find_sign", HTTP_POST, [](AsyncWebServerRequest * request) {
    int sign_num = request->getParam("sign")->value().toInt();
    ledcWriteTone(buzzer_pwm_channel, sign_num*100);
    request->send(200);
  });
